// src/components/paralegal/behaviours.tsx
...
export function Behaviours() {
  return (
    <Card className="h-full bg-[rgba(191,219,254,0.20)] transition-all hover:bg-[rgba(191,219,254,0.30)]">
      <Link href="/behaviours" className="flex h-full flex-col">
        ...
        <CardContent className="flex flex-1 items-center justify-center">
          <p className="text-center text-sm text-[#525766]">Click to view and manage VP Behaviours</p>
        </CardContent>
      </Link>
    </Card>
  )
