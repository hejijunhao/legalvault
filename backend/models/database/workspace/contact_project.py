...
class ContactProjectBase(SQLModel, ABC):
    ...
    contact: Optional["ContactBase"] = Relationship(
        ...
        sa_relationship_kwargs={
            "lazy": "selectin",
            "primaryjoin": "and_(foreign(ContactProjectBase.contact_id)==ContactBase.contact_id, "
    ...
    project: Optional["ProjectBase"] = Relationship(
        ...
        sa_relationship_kwargs={
            "lazy": "selectin",
            "primaryjoin": "and_(foreign(ContactProjectBase.project_id)==ProjectBase.project_id, "
...
class ContactProjectBlueprint(ContactProjectBase, table=True):
    ...
    __table_args__ = (
        *ContactProjectBase.__table_args__,
        {'schema': 'public'}
    )
